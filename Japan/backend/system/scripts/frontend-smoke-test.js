...
async function main() {
  ...
  assert.match(html, /japan\.fullTourPreviewFormat/);
  assert.match(html, /saveFullTourPreviewFormat\(/);
  assert.match(html, /getSavedFullTourPreviewFormat\(/);
  assert.match(html, /copyFullTourReport\('markdown'\)/);
  assert.match(html, /copyFullTourReport\('json'\)/);
  assert.match(html, /downloadFullTourReport\('markdown'\)/);
  assert.match(html, /downloadFullTourReport\('json'\)/);
  ...
  assert.match(html, /management-preview-health/);
  assert.match(html, /management-preview-pressure-breakdown/);
  assert.match(html, /management-preview-action-types/);
  assert.match(html, /management-preview-action-detail/);
  assert.match(html, /management-preview-pending-list/);
  assert.match(html, /runManagementCycle\(\)/);
  assert.match(html, /runTrafficReviewCycle\(\)/);
  assert.match(html, /console\/management-cycle/);
  assert.match(html, /console\/traffic-review-cycle/);
  assert.match(html, /product-flow-summary/);
  assert.match(html, /product-flow-next/);
  assert.match(html, /product-flow-stages/);
